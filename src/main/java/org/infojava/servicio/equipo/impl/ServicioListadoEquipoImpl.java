...
import org.infojava.servicio.equipo.ServicioListadoEquipo;
...
import org.infojava.servicio.salida.file.impl.ServicioSalidaArchivoImpl;
...
public class ServicioListadoEquipoImpl implements ServicioListadoEquipo {
    ...
    @Override
    public void exportarTodosLosEquiposOrdenadosPorNombreJugador(boolean esOrdenadoPorNombre, boolean esOrdenadoPorNroCamiseta, boolean esOrdenadoPorPosicionYNroCamiseta) {
        String listado = "";
    ...
    private String getStringJugadoresOrdenadosPorNroCamiseta(List<Jugador> jugadores) {
        ...
        jugadoresLinkedList.sort(new Comparator<Jugador>() {
            @Override
            public int compare(Jugador jugador1, Jugador jugador2) {
                return Integer.compare(jugador1.getNroCamiseta(), jugador2.getNroCamiseta());
            }
        });
        return new ServicioEquipoImpl().getStringJugadores(jugadoresLinkedList);
    }
